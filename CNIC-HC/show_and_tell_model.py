...
class ShowAndTellModel(object):
 ...
 def build_keyword_embeddings(self):
  with tf.variable_scope("hidden_state_word_prob_embedding")as scope:
   hidden_state_word_prob_embeddings=tf.contrib.layers.fully_connected(inputs=self.word_prob,num_outputs=self.config.embedding_size,activation_fn=None,weights_initializer=self.initializer,biases_initializer=None,scope=scope)
  with tf.variable_scope("cell_state_word_prob_embedding")as scope:
   cell_state_word_prob_embeddings=tf.contrib.layers.fully_connected(inputs=self.word_prob,num_outputs=self.config.embedding_size,activation_fn=None,weights_initializer=self.initializer,biases_initializer=None,scope=scope)
  self.hidden_state_word_prob_embeddings=hidden_state_word_prob_embeddings
  self.cell_state_word_prob_embeddings=cell_state_word_prob_embeddings
 def build_lstm_zero_state(self):
  with tf.variable_scope("lstm_zero_state")as scope:
   cell_state=self.cell_state_word_prob_embeddings
   hidden_state=self.hidden_state_word_prob_embeddings
